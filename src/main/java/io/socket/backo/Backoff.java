...
public class Backoff {
    ...
    public io.socket.backo.Backoff setMin(long min) {
        this.ms = min;
        return this;
    }

    public io.socket.backo.Backoff setMax(long max) {
        this.max = max;
        return this;
    }

    public io.socket.backo.Backoff setFactor(int factor) {
        this.factor = factor;
        return this;
    }

    public io.socket.backo.Backoff setJitter(double jitter) {
        this.jitter = jitter;
        return this;
    }
